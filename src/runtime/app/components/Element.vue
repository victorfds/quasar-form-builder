...
import type { ElementType } from '#qfb/types'
...
<template>
  <q-input v-if="elem.type === 'text' && !elem.inputType" outlined :label="elem.label" :hint="elem.description" />
  <q-input
    v-if="elem.type === 'text' && elem.inputType === 'number'" type="number" outlined :label="elem.label"
    :hint="elem.description"
  />
  <q-input
    v-if="elem.type === 'text' && elem.inputType === 'email'" type="email" outlined :label="elem.label"
    :hint="elem.description"
  />
  <q-input v-if="elem.type === 'phone'" type="tel" outlined :label="elem.label" :hint="elem.description" />
  <q-input
    v-if="elem.type === 'text' && elem.inputType === 'password'" type="password" outlined :label="elem.label"
    :hint="elem.description"
  />
  <q-input
    v-if="elem.type === 'text' && elem.inputType === 'url'" type="url" outlined :label="elem.label"
    :hint="elem.description"
  />
  <q-input
    v-if="elem.type === 'textarea'" :autogrow="false" type="textarea" outlined :label="elem.label"
    :hint="elem.description"
  />
  ...
  <q-time v-if="elem.type === 'time'" :label="elem.label" />
  <q-date v-if="elem.type === 'dates'" :label="elem.label" range />
  <q-slider v-if="elem.type === 'slider'" :label="elem.label" :value="30" />
  <q-range v-if="elem.type === 'rangeSlider'" :label="elem.label" :min="30" :max="70" />
  <q-slider v-if="elem.type === 'verticalSlider'" vertical />
  <q-file v-if="elem.type === 'file'" :label="elem.label" />
  <q-file v-if="elem.type === 'multifile'" multiple :label="elem.label" />
